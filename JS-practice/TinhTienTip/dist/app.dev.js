...
function calculateTip() {
  ...
  var soNguoiShare = getEle("peopleamt").value; //Validation 
  ...
  var tongTip = tongBill * haiLongVaTip / soNguoiShare; // làm tròn đến phần thập phân có 2 chữ số

  tongTip = Math.round(tongTip * 100) / 100; //Đảm bảo lúc nào cũng có 2 chữ số ở phần thập phân

  tongTip = tongTip.toFixed(2); //Hiển thị vùng div tiền tip
